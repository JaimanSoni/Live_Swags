    ...
    return (
        <div>
            <div className="text-center my-[30px] font-semibold px-[30px]  ">
                <h1 className=" text-[28px] md:text-[38px] text-[#252525] tracking-[0.5px] mt-[40px] leading-[38px] md:leading-[45px] font-[Merriweather]">Get Ready for AI-Conclave: Claim your Live Swag!</h1>
                <p className=" text-[17px] text-[#4c4c4c] tracking-[0.5px] m-auto mt-[30px] mb-[50px] w-[100%] sm:w-[80%]">Design and tailor your AI-Conclave participant image easily with our intuitive image creation tool, ensuring a distinctive representation of your attendance without the need for complex customization processes.</p>
            </div>
            <div className="  m-auto w-[85%] flex flex-col gap-[20px] md:flex-row items-center gap-x-[15%] justify-center">
                ...
                <div className="flex flex-row md:flex-col justify-center gap-[10px] md:gap-[50px] items-center">
